...
public class CyActivator extends AbstractCyActivator {
    ...
    public DirectedClosenessMenuAction menuaction;
    ...
    public void start(BundleContext context) throws Exception {
        ...
        System.out.println("directed Closeness Interference is loaded");
        ...
        menuaction = new DirectedClosenessMenuAction(cyApplicationManager, "Directed Closeness Interference" + version, this);
